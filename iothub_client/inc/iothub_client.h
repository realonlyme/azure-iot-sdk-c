...
extern "C"
{
    ...
    * @param    config                          Pointer to an @c IOTHUB_CLIENT_CONFIG structure
    *
    *           The API allows sharing of a connection across
    *           multiple devices. This is a blocking call.
    *
    * @return   A non-NULL @c IOTHUB_CLIENT_HANDLE value that is
    *           used when invoking other functions for IoT Hub
    *           client and @c NULL on failure.
    */
    ...
    */
    ...
    /**
    * @brief    Disposes of resources allocated by the IoT Hub client. This is a blocking call.
    *
    ...
    *            @b NOTE: The application behavior is undefined if the user calls
    *            the ::IoTHubClient_LL_Destroy function from within any callback.
    *            Usage: user has to call IoTHubClient_SetDeviceTwinCallback API 
    *            before calls IoTHubClient_GetDeviceTwin to have the twin callback function set up
    *
    * @return    IOTHUB_CLIENT_OK upon success or an error code upon failure.
    */
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClient_GetDeviceTwin, IOTHUB_CLIENT_HANDLE, iotHubClientHandle);
