...
IOTHUB_CLIENT_RESULT IoTHubClient_LL_GetDeviceTwin(IOTHUB_CLIENT_LL_HANDLE iotHubClientHandle)
{
    return IoTHubClientCore_LL_GetDeviceTwin((IOTHUB_CLIENT_CORE_LL_HANDLE)iotHubClientHandle);
}
